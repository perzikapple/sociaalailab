...
<head>
    ...
    <link rel="preload" as="style" href="build/assets/app-DozK-03z.css"><link rel="modulepreload" as="script" href="build/assets/app-CAiCLEjY.js"><link rel="stylesheet" href="build/assets/app-DozK-03z.css"><script type="module" src="build/assets/app-CAiCLEjY.js"></script>    <title>programma</title>
...
<main>
     <div class="mobile flex  items-center justify-center">
         <div class="bg-white p-6 shadow-lg max-w-xl mt-6 w-full border-r text-center">
            <a href="agenda.html"><h1 class="text-2xl  hover:text-[#00811F] font-semibold">Agenda</h1></a>
        </div>
        <div class="bg-white p-6 max-w-xl mt-6 w-full text-center border-r border-gray-500">
            <a href="terugblik.html"><h1 class="text-2xl text-[#00811F] font-semibold">Terugblik</h1></a>
        </div>
    </div>
        ...
        <span class="inline-block bg-[#00811F] text-white text-sm font-medium px-4 py-1 mb-4">
           ...
           <div class="space-y-4">
              ...
              <a href="event.html" class="inline-block bg-[#00811F] text-white font-medium px-6 py-2 hover:bg-green-700 transition">
                    Meer info
            </a>
        </div>
        <div class="flex-1">
    ...
    <section class="flex flex-col md:flex-row items-center gap-10 bg-white shadow-lg p-8 max-w-6xl mx-auto my-12">
        ...
        <div class="flex-1">
            <img src="images/event/Agenda_event_3.png" alt="SociaalAI Inspiratiedag" class="w-full object-cover shadow-md">
        </div>
    </section>
        ...
        <span class="inline-block bg-[#00811F] text-white text-sm font-medium px-4 py-1 mb-4">
           ...
           <div class="space-y-4">
               ...
               <div class="flex-1">
            <img src="images/event/Agenda_event_1.png" alt="SociaalAI Inspiratiedag" class="w-full object-cover shadow-md">
        </div>
        </section>
