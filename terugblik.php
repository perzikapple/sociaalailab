...
<main>
     <div class="mobile flex  items-center justify-center">
        ...
        <div class="bg-white p-6 max-w-xl mt-6 w-full text-center border-r border-gray-500">
            <a href="terugblik.php"><h1 class="text-2xl text-[#00811F] font-semibold">Terugblik</h1></a>
        </div>
    </div>
        ...
        <span class="inline-block bg-[#00811F] text-white text-sm font-medium px-4 py-1 mb-4">
           ...
           <div class="space-y-4">
              ...
              <a href="event.php" class="inline-block bg-[#00811F] text-white font-medium px-6 py-2 hover:bg-green-700 transition">
                    Meer info
            </a>
        </div>
        <div class="flex-1">
